---
title: |
  This Is the Sample Article Template for _mSystems_ \textsuperscript{\textregistered}, an American Society for Microbiology (ASM) Journal
format:
  asm-pdf:
    keep-tex: true
    classoption:
...
equalcontrib: First Author and Second Author contributed equally to this work. Author order was determined XXXXXX.
author:
  - name: First Author
    affiliations:
      - ref: a
  ...
  - name: Third Author
    affiliations:
      - ref: b
  - name: Third Final Author
    affiliations:
      - ref: a
      - ref: b
    email: fourth@author.edu
    corresponding: true
affiliations:
  - id: a
    name: University Name, Faculty Group, Department, City, Country
  - id: b
...
\dropcap{P}lease read the [Instructions to Authors](https://journals.asm.org/journal/msystems/submission-review-process) carefully, or browse the [FAQs](https://journals.asm.org/journal/msystems/faq) for further details.
...
![This is an example figure with caption. Use the fullwidth environment to make it span the entire width of the page. Lorem ipsum dolor sit amet, consectetur adipiscing elit.](style-guide/example-image-16x9.png){#fig-example}

## Sectioning commands.

Use `#` to get a first-level heading. You can use `##` to get a sub-heading. Further sectioning levels, such as `###`, etc., are ignored.

Sections **must** be ordered as follows:
